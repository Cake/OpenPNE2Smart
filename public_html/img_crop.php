...
require_once 'OpenPNE/ImgCrop.php'; // 改変部
$options = array(
    'dsn'          => $dsn,
...
if ($use_IM) {
    require_once 'OpenPNE/Img/ImageMagickCrop.php';
    $img =& new OpenPNE_Img_ImageMagickCrop($options);
} else {
    $img =& new OpenPNE_ImgCrop($options);
}
