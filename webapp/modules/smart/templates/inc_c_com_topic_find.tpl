({* {{{ searchFormLine *})
<section class="searchFormBox" id="searchCommunity({$c_commu.c_commu_id})TopicFormBox" data-role="collapsible" data-collapsed="({if $keyword})false({else})true({/if})" data-content-theme="c">
<h3>検索</h3>
