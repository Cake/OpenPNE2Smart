...
<span class="next"><a href="javascript:void(0);" onclick="submitPagerPage('({t_url m=pc a=page_c_event_list_ajax})&amp;target_c_commu_id=({$c_commu.c_commu_id})', 'asc', '#({$INC_HEADER_page_name})({$c_commu.c_commu_id}) li.bbsList', 'eventList({$c_commu.c_commu_id})NextPager', '({$total_page_num})', true); return false;" data-role="button" data-icon="arrow-r" data-iconpos="right" data-inline="false" data-mini="false" data-ajax="true">もっと読む</a></span>
</div>
({/if})
({/strip})({* Pager }}} *})
({/if})({* commentListBox }}} *})
