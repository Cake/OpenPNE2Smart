...
<a class="listItemLink" href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$item.c_member_id})" id="memberLink({$item.c_diary_id})"><section class="authorBar">
...
<!-- a title="削除" class="" href="({t_url m=pc a=page_h_bookmark_list})" onclick="" data-rel="back" data-ajax="false">削除</a --!>
