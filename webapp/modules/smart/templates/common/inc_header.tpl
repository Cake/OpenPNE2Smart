...
({* {{{ Search Box *})({strip})<a class="ui-btn-right ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-notext " data-iconpos="notext" data-icon="search" href="({t_url m=pc a=page_h_search})" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" title="Search">
<span class="ui-btn-inner ui-btn-corner-all">
