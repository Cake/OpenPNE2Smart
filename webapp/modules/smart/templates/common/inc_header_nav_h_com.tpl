...
<li id="navSearchCommunity" class="ui-block-c"><a href="({t_url m=pc a=page_h_com_find_all})" class="({if $INC_HEADER_page_name == 'h_com_find_all'}) ui-btn-active({/if})" data-role="button" data-corners="false" data-mini="true">({$WORD_COMMUNITY_HALF})検索</a></li>
</div>({* navHomeCom }}} *})
