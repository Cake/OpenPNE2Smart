...
<li id="navTopicList" class="ui-block-a"><a href="({t_url m=pc a =page_c_topic_list})&amp;target_c_commu_id=({$c_commu.c_commu_id})" data-role="button" data-corners="false" data-mini="true">掲示板</a></li>
