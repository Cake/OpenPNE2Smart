...
<div class="photo48"><img class="ui-li-thumb memberPhoto" src="({t_img_url filename=$item.c_commu_image_filename w=48 h=48 noimg=no_image trim=square})" alt="プロフィール写真"></div>
<div class="itemData">
