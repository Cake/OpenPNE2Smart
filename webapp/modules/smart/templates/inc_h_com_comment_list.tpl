...
<a class="listItemLink" href="({t_url m=pc a=page_c_topic_detail})&amp;target_c_commu_topic_id=({$item.c_commu_topic_id})&amp;comment_count=({$item.number})" id="bbs({$item.c_commu_topic_id})"><section class="authorBar">
<div class="photo48"><img class="ui-li-thumb" src="({t_img_url filename=$item.c_commu_image_filename  w=48 h=48 noimg=no_image})" alt=""></div>
<div class="itemData">
