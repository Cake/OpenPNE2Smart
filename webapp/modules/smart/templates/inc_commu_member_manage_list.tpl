...
<a href="({t_url m=pc a=page_c_edit_member_delete_c_commu_member})&amp;target_c_commu_id=({$c_commu.c_commu_id})&amp;target_c_member_id=({$item.c_member_id})" id="community({$c_commu.c_commu_id})Member({$item.c_member_id})Delete" data-role="button" data-inline="false" data-ajax="true">退会させる</a>
({/if})
...
<a href="({t_url m=pc a=page_c_sub_admin_request})&amp;target_c_commu_id=({$c_commu.c_commu_id})&amp;target_c_member_id=({$item.c_member_id})" id="community({$c_commu.c_commu_id})Member({$item.c_member_id})Subadmin" data-role="button" data-inline="false" data-ajax="true">副管理者に指名</a>
 ({/if})
...
<a href="({t_url m=pc a=page_c_admin_request})&amp;target_c_commu_id=({$c_commu.c_commu_id})&amp;target_c_member_id=({$item.c_member_id})" id="community({$c_commu.c_commu_id})Member({$item.c_member_id})admin" data-role="button" data-inline="false" data-ajax="true">管理権を渡す</a>
({/if})
</div>
