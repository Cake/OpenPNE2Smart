...
<div class="photo" id="member({$item.c_member_id})photo"><img class="memberPhoto" src="({t_img_url filename=$item.image_filename w=76 h=76 noimg=no_image})" alt="({$item.nickname})"></div>
