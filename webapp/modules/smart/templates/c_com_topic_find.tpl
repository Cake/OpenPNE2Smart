...
<div class="photo48"><a href="({t_url m=pc a=page_c_home})&amp;target_c_commu_id=({$c_commu.c_commu_id})"><img src="({t_img_url filename=$c_commu.image_filename w=48 h=48 noimg=no_image})" class="memberPhoto" alt=""></a></div>
<div class="itemData">
<div class="title">
