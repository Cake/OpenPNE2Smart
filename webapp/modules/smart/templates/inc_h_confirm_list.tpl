...
<div class="photo48 communityRequest"><a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$c_member_id})" class="listItemLink"><img class="ui-li-thumb memberPhoto" src="({t_img_url filename=$item.image_filename w=48 h=48 noimg=no_image trim=square})" alt="プロフィール写真"></a></div>
